#
# Be sure to run `pod lib lint NSURLSession-Resplendent.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/NSURLSession-Resplendent.git", :tag => s.version.to_s }
  ...
  s.resource_bundles = {
    'NSURLSession-Resplendent' => ['Pod/Assets/*.png']
  }
